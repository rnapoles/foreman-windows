...
namespace Foreman.UI.Components
{
    ...
    {
        private Color m_borderColor = Color.FromArgb(127, 157, 185);
        ...
        private void PaintTabBorder(System.Drawing.Graphics graph, int index, System.Drawing.Drawing2D.GraphicsPath path)
        {
            ...
            if (index == this.SelectedIndex)
            {
                borderPen = new Pen(m_borderColor);
            }
        ...
        private void PaintTheTabPageBorder(System.Windows.Forms.PaintEventArgs e)
        {
            if (this.TabCount > 0)
            {
                ...
                ControlPaint.DrawBorder(e.Graphics, borderRect, m_borderColor, ButtonBorderStyle.Solid);
            }
        }
